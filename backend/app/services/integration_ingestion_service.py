...
def execution_to_dict(
    ...
    return {
        ...
        "accountsScanned": (
            execution.accounts_scanned
        ),
        "duplicateGroups": (
            execution.duplicate_groups
        ),
        "duplicateAccounts": (
            execution.duplicate_accounts
        ),
        "errorMessage": (
            execution.error_message
        ),
        "startedAt": _to_india_iso(
            execution.started_at
        ),
        "completedAt": _to_india_iso(
...
def execute_integration(
    ...
    *,
    ...
    """
    Execute one integration ingestion.

    Every completed scan is linked to the integration
    that produced it through ScanRecord.integration_id.
    """
    ...
    try:
        ...
        execution.source_path = (
            connector_file.source_path
        )
        execution.file_checksum = checksum
        execution.accounts_scanned = len(
            accounts
        )
        execution.duplicate_groups = (
