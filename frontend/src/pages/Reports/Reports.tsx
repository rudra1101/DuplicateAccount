  ...
  return (
    <Stack spacing={3}>
        ...
        <Stack direction="row" spacing={1.5} alignItems="center">
          ...
          <Box>
            ...
            <Typography color="text.secondary">
              Build on-demand reports or manage scheduled report delivery and history.
            </Typography>
          </Box>
        </Stack>
      </Box>
      ...
      <Card variant="outlined">
        <Tabs
          value={activeTab}
          onChange={(_, value: "builder" | "scheduled") => {
            setActiveTab(value);
            setError("");
          }}
          sx={{ px: 2 }}
        >
          <Tab value="builder" label="Report Builder" />
          <Tab value="scheduled" label="Scheduled Reports" />
        </Tabs>
      </Card>
